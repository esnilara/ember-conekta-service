...
export default Service.extend({
  ...
  _createCardToken(card) {
    ...
    return this.conektaPromise((resolve, reject) => {
      Conekta.Token.create(card, (status, response) => {
        debug('Conekta.Token.create handler - status %s, response:', status, response);
